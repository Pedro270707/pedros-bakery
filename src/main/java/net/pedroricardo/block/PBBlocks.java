...
public class PBBlocks {
    public static final Block CAKE = register("cake", new PBCakeBlock(AbstractBlock.Settings.copy(Blocks.CAKE).dynamicBounds().nonOpaque().solidBlock(Blocks::never).blockVision(Blocks::never)), (name, block) -> PBItems.register(name, new PBCakeBlockItem(block, new Item.Settings())));
    ...
    public static final Block EXPANDABLE_BAKING_TRAY = register("expandable_baking_tray", new BakingTrayBlock(AbstractBlock.Settings.copy(BAKING_TRAY)), (name, block) -> PBItems.register(name, new ExpandableBakingTrayItem(block, new Item.Settings().maxCount(1))));
