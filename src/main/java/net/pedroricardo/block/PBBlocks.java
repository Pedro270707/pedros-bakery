...
public class PBBlocks {
    ...
    public static final Block INDUCTION_OVEN = register("induction_oven", new Block(AbstractBlock.Settings.create().mapColor(MapColor.STONE_GRAY).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(3.5f)));
