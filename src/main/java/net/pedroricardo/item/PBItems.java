...
public class PBItems {
    ...
    public static final Item QUESADILLA = register("quesadilla", new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(5).saturationModifier(1.0f).build())));
    public static final Item CROISSANT = register("croissant", new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(4).saturationModifier(0.6f).build())));
