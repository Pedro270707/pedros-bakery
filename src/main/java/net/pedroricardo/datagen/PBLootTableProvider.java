...
public class PBLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        this.addDrop(PBBlocks.BAKING_TRAY, LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(PBBlocks.BAKING_TRAY).apply(CopyComponentsLootFunction.builder())
        ...
        this.addDrop(PBBlocks.EXPANDABLE_BAKING_TRAY, LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(PBBlocks.EXPANDABLE_BAKING_TRAY).apply(CopyComponentsLootFunction.builder())
                .conditionally(BlockStatePropertyLootCondition.builder(PBBlocks.BAKING_TRAY).properties(StatePredicate.Builder.create().exactMatch(MultipartBlock.IS_MAIN_PART, true)))
        ).build()));
        ...
        this.addDrop(PBBlocks.POLISHED_CHEESE, dropsWithSilkTouch(PBBlocks.POLISHED_CHEESE, this.applyExplosionDecay(PBBlocks.POLISHED_CHEESE, ItemEntry.builder(PBItems.HARD_CHEESE).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(4.0f))))));
        this.addDrop(PBBlocks.POLISHED_CHEESE_SLAB, dropsWithSilkTouch(PBBlocks.POLISHED_CHEESE_SLAB, this.applyExplosionDecay(PBBlocks.POLISHED_CHEESE_SLAB, ItemEntry.builder(PBItems.HARD_CHEESE).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0f))))));
        this.addDrop(PBBlocks.POLISHED_CHEESE_STAIRS, dropsWithSilkTouch(PBBlocks.POLISHED_CHEESE_STAIRS, this.applyExplosionDecay(PBBlocks.POLISHED_CHEESE_STAIRS, ItemEntry.builder(PBItems.HARD_CHEESE).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(4.0f))))));
        this.addDrop(PBBlocks.POLISHED_CHEESE_WALL, dropsWithSilkTouch(PBBlocks.POLISHED_CHEESE_WALL, this.applyExplosionDecay(PBBlocks.POLISHED_CHEESE_WALL, ItemEntry.builder(PBItems.HARD_CHEESE).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(4.0f))))));
        this.addDrop(PBBlocks.POLISHED_CHEESE_BRICKS, dropsWithSilkTouch(PBBlocks.POLISHED_CHEESE_BRICKS, this.applyExplosionDecay(PBBlocks.POLISHED_CHEESE_BRICKS, ItemEntry.builder(PBItems.HARD_CHEESE).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(4.0f))))));
