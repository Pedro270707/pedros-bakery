...
public class PBENLanguageProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder builder) {
        ...
        builder.add(PBItems.TORTILLA, "Tortilla");
        builder.add(PBItems.QUESADILLA, "Quesadilla");
        builder.add(PBItems.CROISSANT, "Croissant");
        ...
        builder.add("itemGroup." + PedrosBakery.MOD_ID + ".cakes_and_cupcakes", "PB: Cakes and Cupcakes");
        builder.add("itemGroup." + PedrosBakery.MOD_ID + ".cookies", "Pedro's Bakery: Cookies");
        builder.add("itemGroup." + PedrosBakery.MOD_ID + ".miscellaneous", "Pedro's Bakery: Miscellaneous");
        builder.add("pedrosbakery.config.bakingTrayMinSize", "Baking Tray Minimum Size");
        builder.add("pedrosbakery.config.bakingTrayMaxSize", "Baking Tray Maximum Size");
        builder.add("pedrosbakery.config.bakingTrayDefaultSize", "Baking Tray Default Size");
        builder.add("pedrosbakery.config.bakingTrayMinHeight", "Baking Tray Minimum Height");
        builder.add("pedrosbakery.config.bakingTrayMaxHeight", "Baking Tray Maximum Height");
        builder.add("pedrosbakery.config.bakingTrayDefaultHeight", "Baking Tray Default Height");
        builder.add("pedrosbakery.config.maxCakeHeight", "Maximum Cake Height");
        builder.add("pedrosbakery.config.maxCakeHeight.tooltip", "Cakes turn into multi-blocks if\nhigher than 16 blocks.");
        builder.add("pedrosbakery.config.beaterBatterAmount", "Beater Batter Amount");
        builder.add("pedrosbakery.config.biteSize", "Bite Size");
        builder.add("pedrosbakery.config.ticksUntilCakeBaked", "Ticks Until Cake Baked");
        builder.add("pedrosbakery.config.ticksUntilPieBaked", "Ticks Until Pie Baked");
        builder.add("pedrosbakery.config.cakeBiteFood", "Cake Bite Food");
        builder.add("pedrosbakery.config.cakeBiteSaturation", "Cake Bite Saturation");
        builder.add("pedrosbakery.config.cupcakeFood", "Cupcake Food");
        builder.add("pedrosbakery.config.cupcakeSaturation", "Cupcake Saturation");
        builder.add("pedrosbakery.config.pieSliceFood", "Pie Slice Food");
        builder.add("pedrosbakery.config.pieSliceSaturation", "Pie Slice Saturation");
        builder.add("pedrosbakery.config.cakeRenderQuality", "Cake Render Quality");
        builder.add("pedrosbakery.config.enum.cakeRenderQuality.SIMPLE", "Simple");
        builder.add("pedrosbakery.config.enum.cakeRenderQuality.BORDERS_ON_SIDES", "Borders on Sides");
        builder.add("pedrosbakery.config.enum.cakeRenderQuality.BORDERS_ON_SIDES_AND_TOP", "Borders on Sides and Top");
        builder.add("pedrosbakery.config.enum.cakeRenderQuality.ALL_BORDERS", "All Borders");
    }
}
