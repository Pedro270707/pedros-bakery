...
public class PBItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        this.getOrCreateTagBuilder(ConventionalItemTags.FOODS).add(PBItems.DONUT, PBItems.APPLE_COOKIE, PBItems.BUTTER, PBItems.SHAPED_COOKIE, PBItems.CHEESE, PBItems.TORTILLA, PBItems.QUESADILLA, PBItems.CROISSANT);
    }
}
