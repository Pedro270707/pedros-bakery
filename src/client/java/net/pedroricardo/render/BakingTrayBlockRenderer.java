    ...
    public void render(BakingTrayBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        if (!batter.isEmpty()) {
            ...
            if (PedrosBakery.CONFIG.cakeRenderQuality().renderTopBorder()) {
                PBRenderHelper.createFace(Direction.UP, matrices, vertexConsumer, 8.0f - size / 2.0f, 8.0f - size / 2.0f, batter.getHeight(), size, size, 16.0f + Math.round(8.0f - size / 2.0f), 80.0f, light, PBCakeBlockRenderer.getBakeTimeOverlay(batter.getBakeTime(), overlay), PBCakeBlockRenderer.getBakeTimeColor(batter.getBakeTime(), color)); // Top
                PBRenderHelper.createFace(Direction.UP, matrices, vertexConsumer, 8.0f - size / 2.0f, 8.0f - size / 2.0f, batter.getHeight(), size, size, 16.0f + Math.round(8.0f - size / 2.0f), 128.0f - size, light, PBCakeBlockRenderer.getBakeTimeOverlay(batter.getBakeTime(), overlay), PBCakeBlockRenderer.getBakeTimeColor(batter.getBakeTime(), color)); // Bottom
                PBRenderHelper.createFace(Direction.UP, matrices, vertexConsumer, 8.0f - size / 2.0f, 8.0f - size / 2.0f, batter.getHeight(), size, size, 0.0f, 96.0f + Math.round(8.0f - size / 2.0f), light, PBCakeBlockRenderer.getBakeTimeOverlay(batter.getBakeTime(), overlay), PBCakeBlockRenderer.getBakeTimeColor(batter.getBakeTime(), color)); // Left
                PBRenderHelper.createFace(Direction.UP, matrices, vertexConsumer, 8.0f - size / 2.0f, 8.0f - size / 2.0f, batter.getHeight(), size, size, 48.0f - size, 96.0f + Math.round(8.0f - size / 2.0f), light, PBCakeBlockRenderer.getBakeTimeOverlay(batter.getBakeTime(), overlay), PBCakeBlockRenderer.getBakeTimeColor(batter.getBakeTime(), color)); // Right
                PBRenderHelper.createFace(Direction.UP, matrices, vertexConsumer, 8.0f - size / 2.0f, 8.0f - size / 2.0f, batter.getHeight(), size, size, 0.0f, 80.0f, light, PBCakeBlockRenderer.getBakeTimeOverlay(batter.getBakeTime(), overlay), PBCakeBlockRenderer.getBakeTimeColor(batter.getBakeTime(), color)); // Top Left
                PBRenderHelper.createFace(Direction.UP, matrices, vertexConsumer, 8.0f - size / 2.0f, 8.0f - size / 2.0f, batter.getHeight(), size, size, 48.0f - size, 80.0f, light, PBCakeBlockRenderer.getBakeTimeOverlay(batter.getBakeTime(), overlay), PBCakeBlockRenderer.getBakeTimeColor(batter.getBakeTime(), color)); // Top Right
                PBRenderHelper.createFace(Direction.UP, matrices, vertexConsumer, 8.0f - size / 2.0f, 8.0f - size / 2.0f, batter.getHeight(), size, size, 0.0f, 128.0f - size, light, PBCakeBlockRenderer.getBakeTimeOverlay(batter.getBakeTime(), overlay), PBCakeBlockRenderer.getBakeTimeColor(batter.getBakeTime(), color)); // Bottom Left
                PBRenderHelper.createFace(Direction.UP, matrices, vertexConsumer, 8.0f - size / 2.0f, 8.0f - size / 2.0f, batter.getHeight(), size, size, 48.0f - size, 128.0f - size, light, PBCakeBlockRenderer.getBakeTimeOverlay(batter.getBakeTime(), overlay), PBCakeBlockRenderer.getBakeTimeColor(batter.getBakeTime(), color)); // Bottom Right
            }
        }
        matrices.pop();
    }
